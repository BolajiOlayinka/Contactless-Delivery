    ...
    _createClass(ProductVariants, [{
      ...
      value: function _updateAddToCartButton(newVariant) {
        ...
        if (!newVariant) {
          ...
          var htmlSpan = addToCartButtonElement.querySelector("span");
          if(htmlSpan) {
            htmlSpan.innerHTML = window.languages.productFormUnavailable;
          } else {
          ...
          if (newVariant['available']) {
            ...
            var htmlSpan = addToCartButtonElement.querySelector("span");
            if(htmlSpan) {
                htmlSpan.innerHTML = window.languages.productFormAddToCart;
            } else {
            ...
            var htmlSpan = addToCartButtonElement.querySelector("span");
              if(htmlSpan) {
                htmlSpan.innerHTML = window.languages.productFormSoldOut;
              } else {
                    addToCartButtonElement.innerHTML = window.languages.productFormSoldOut;
              }
                addToCartButtonElement.querySelector("span").innerHTML = window.languages.productFormSoldOut;
              }
        }
